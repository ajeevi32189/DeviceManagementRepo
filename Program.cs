...
builder.Services.AddScoped<IModelProtocolService, ModelProtocolService>();
...
// ── Generic Import / Export (Excel, CSV, PDF, DXF + field mapping) ──
builder.Services.AddScoped<DeviceManagementOnly.Common.ImportExport.IExportService, DeviceManagementOnly.Common.ImportExport.ExportService>();
builder.Services.AddScoped<DeviceManagementOnly.Common.ImportExport.IImportService, DeviceManagementOnly.Common.ImportExport.ImportService>();
